...
const CFP = ({topics, className = ""} = {}) => {
  ...
  <div className={className}>
    <p className="md:text-lg">
      ...
      registration system <a href="https://uconfy.com/conf/16/" target="_blank" className="text-indigo-700">uConfy.com</a>.
    ...
    <div className="pl-8 mt-8">
      <a href="/downloads/DCCN2024_LaTeX_RU.zip" className="text-indigo-700">
        <FontAwesomeIcon icon={faArchive} size="lg" className="mr-3"/>
        <span className="md:text-lg align-middle">Template in Russian</span>
      </a>
    </div>
    <div className="pl-8 mt-4">
      <a href="/downloads/DCCN2024_LaTeX_EN.zip" className="text-indigo-700">
        <FontAwesomeIcon icon={faArchive} size="lg" className="mr-3"/>
